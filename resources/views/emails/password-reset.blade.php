        ...
        <div class="email-container">
            ...
            <div class="email-body">
                ...
                <div class="email-text">
                    We received a request to reset the password for your IsDB-BISEW Connect account.
                    Click the button below to set a new password.
                </div>
                <div class="email-button-wrap">
                    <a class="email-button" href="{{ $url }}">Reset Password</a>
                </div>
                <div class="email-expiry">
                    This link will expire in {{ $expire }} minutes.
                </div>
                <div class="email-text" style="margin-top: 20px;">
                    If you did not request a password reset, please ignore this email. No changes
